	...
	<div class="col-sm-8">
		<div id="signature-pad" class="m-signature-pad">
			...
			<div class="m-signature-pad--footer">
				<button type="button" class="btn btn-primary" id="clearBtn" data-action="clear" style="visibility: hidden;">Clear</button>
			</div>
		</div>
	</div>
	<div class="col-sm-2"></div>
...
<div class="row">
	...
	<div class="col-sm-8">
		<div class="col-sm-6">
			<button type="button" class="btn btn-block btn-warning" onclick="$('#clearBtn').click();">
				<span class="glyphicon glyphicon-remove"></span> Clear
			</button><br/>
		</div>
		<div class="col-sm-6">
			<button type="button" class="btn btn-block btn-primary" onclick="saveSignature();">
...
<script>
	function saveSignature(){
		if (signaturePad.isEmpty()) {
			...
			var signature = signaturePad.toDataURL('image/png',1.0);
			var row = '<?php echo $row; ?>';
			var datas="row="+row+"&signature="+signature;
			$.ajax({
				type: "POST",
