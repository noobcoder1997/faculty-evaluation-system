<?php
	...
	$loadBody = "dashboardTab(),evalRecordTab(),evaluatedTab(),adminTab(),supervisorTab(),departmentTab(),formTab(),scheduleTab(),commiTab(),scheduleTable(),facultyTab(),studentTab(),evaluationTab(),overallTab(),summaryTab();";
...
//	if($position == "Super Administrator" || $position == "Administrator"){
//		$loadBody = "dashboardTab(),adminTab(),supervisorTab(),departmentTab(),formTab(),evaluationTab(),facultyTab(),studentTab(),scheduleTab(),scheduleTable(),overallTab(),summaryTab(),evaluatedTab(),commiTab();";
//	}
	if($position == "Supervisor"){
		$loadBody = "dashboardTab(),evalRecordTabF(),evalRecordTabF(),evaluatedTab(),overallTab(),summaryTab();";
	}
	if($position == "Student"){
			...
			<div id="sidebar-wrapper">
				<ul class="sidebar-nav">
					...
					?>
						<li>Evaluation</li>
						<li>
							<a href="#evaluateRecordTabF" data-toggle="tab" id="btn17"><span class="glyphicon glyphicon-edit"></span> Evaluate</a>
						</li>
					<?php
						}
					...
					<li>SETUP</li>
					<li>
						<a href="#dptTab" data-toggle="tab" id="btn4"><span class="glyphicon glyphicon-th-list"></span> Department</a>
					</li>
					<li>
						<a href="#evlTab" data-toggle="tab" id="btn5"><span class="glyphicon glyphicon-tasks"></span> Evaluation</a>
					</li>
					<li>
						<a href="#frmTab" data-toggle="tab" id="btn6"><span class="glyphicon glyphicon-file"></span> Form</a>
					</li>
					<li>
						<a href="#schedTab" data-toggle="tab" id="btn7"><span class="glyphicon glyphicon-list"></span> Schedule</a>
					</li>
					<li>
						<a href="#facTab" data-toggle="tab" id="btn8"><span class="glyphicon glyphicon-user"></span> Faculty</a>
					</li>
					<li>
						<a href="#commiTab" data-toggle="tab" id="btn18"><span class="glyphicon glyphicon-user"></span> Committee</a>
					</li>
					<li>ACCOUNT</li>
					<li>
						<a href="#admnTab" data-toggle="tab" id="btn9"><span class="glyphicon glyphicon-user"></span> Administrator</a>
					</li>
					<li>
						<a href="#svTab" data-toggle="tab" id="btn10"><span class="glyphicon glyphicon-user"></span> Supervisor</a>
					</li>
					<li>
						<a href="#stdTab" data-toggle="tab" id="btn11"><span class="glyphicon glyphicon-user"></span> Student</a>
					</li>
					<?php
						}
						if($position != 'Student'){
					...
					<li>Report</li>
					<li>
						<a href="#evaluatedTab" data-toggle="tab" id="btn12"><span class="glyphicon glyphicon-check"></span> Evaluation Report</a>
					</li>
					<?php
//						}
//						if($position == 'Administrator' || $position == 'Super Administrator'){
					?>
					<li>
						<a href="#overallTab" data-toggle="tab" id="btn13"><span class="glyphicon glyphicon-tasks"></span> Faculty Report</a>
					</li>
					<li>
						<a href="#sumTab" data-toggle="tab" id="btn14"><span class="glyphicon glyphicon-list-alt"></span> Summary</a>
					</li>
					<?php
						}
					?>
			...
			<div id="page-content-wrapper">
				...
				<div class="tab-content">
					...
					<div id="evaluateRecordTab" class="tab-pane fade in active">
						<div id="evalRecordTab"></div>
					</div>
					<?php
						}else{
					?>
					<div id="evaluateRecordTabF" class="tab-pane fade">
						<div id="evalRecordTabF"></div>
					</div>
					<?php
						}
					?>
