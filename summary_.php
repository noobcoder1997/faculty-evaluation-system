						...
						while ($rf = mysqli_fetch_assoc($resFaculty1)){
							...
							if($fac_no != ""){
								...
								function downloadSummary<?php echo $rf['row'];?>(){
									...
									doc.text("SOUTUERN LEYTE STATE UNIVERSITY - SAN JUAN CAMPUS", 108,15,'center');
									...
									doc.text("SUMMARY COMPUTATION FOR INSTRYCTION PER AREA OF EVALATION",108,35,'center');
									...
									doc.setFontType("bold");
									doc.text(90,45, "<?php echo $ay1." - ".$ay3;?>");
									if("<?php echo $rf['mn'];?>" == ""){
									...
									doc.text("Overall Chair", 64,axis+40,'center');
									doc.text("Human Resource Officer", 64,axis+70,'center');
									doc.text("Member", 64,axis+100,'center');
									
									doc.text("College Dean", 150,axis+40,'center');
									doc.text("Faculty President", 150,axis+70,'center');
									doc.text("Member", 150,axis+100,'center');
									...
									doc.setFontType("italic");
									doc.setTextColor(56,138,220);
									doc.text("SUMMARY OF COMPUTATION FOR INSTRYCTION ARE PER RATING PERIOD",108,35,'center');
